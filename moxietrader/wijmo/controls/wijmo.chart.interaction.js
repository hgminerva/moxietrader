            ...
            var RangeSelector = (function () {
                ...
                */
                ...
                RangeSelector.prototype._adjustMinAndMax = function () {
                    var chart = this._chart, self = this, min = self._min, max = self._max, axis = this._orientation === 0 /* X */ ? chart.axisX : chart.axisY, actualMin = axis.actualMin, actualMax = axis.actualMax, range = actualMax - actualMin;
                ...
                RangeSelector.prototype._updateElesPosition = function () {
                    var left = this._leftEle, middle = this._middleEle, right = this._rightEle, box = this._relaPlotBox, leftCss, middleCss, rightCss, isXAxis = this._orientation === 0 /* X */;
                ...
                RangeSelector.prototype._invalidate = function () {
                    ...
                    rmvClass = this._orientation === 0 /* X */ ? RangeSelector.VSCROLLERCSS : RangeSelector.HSCROLLERCSS;
                ...
                RangeSelector.prototype._getScrollerClass = function () {
                    return this._orientation === 0 /* X */ ? RangeSelector.HSCROLLERCSS : RangeSelector.VSCROLLERCSS;
                };
                ...
                RangeSelector.prototype._onMouseup = function (e) {
                    ...
                    chart = this._chart;
                    axis = this._orientation === 0 /* X */ ? chart.axisX : chart.axisY, actualMin = axis.actualMin, actualMax = axis.actualMax;
