        ...
        var FlexGrid = (function (_super) {
            ...
            */
            function FlexGrid(element, options) {
                ...
                this._indent = 14;
                this._allowResizing = 1 /* Columns */;
                this._autoSizeMode = grid.AutoSizeMode.Both;
                this._allowDragging = 1 /* Columns */;
                this._hdrVis = 3 /* All */;
            ...
            */
            CellFactory.prototype.updateCell = function (panel, r, c, cell, rng) {
                ...
                if (ct == 1 /* Cell */) {
                    ...
                    if (g.editRange && g.editRange.contains(r, c) && col.dataType != 3 /* Boolean */) {
                        selState = 0 /* None */;
                    }
                ...
                switch (ct) {
                    case 3 /* RowHeader */:
                        cell.draggable = !gr && !nr && (g.allowDragging & 2 /* Rows */) != 0;
                        break;
                    case 2 /* ColumnHeader */:
                        cell.draggable = (g.allowDragging & 1 /* Columns */) != 0;
                        break;
                    default:
        ...
        var HitTestInfo = (function () {
            ...
            */
            function HitTestInfo(grid, pt) {
                ...
                var rc = grid.controlRect, tlp = grid.topLeftCells, hdrVis = grid.headersVisibility, hdrWid = (hdrVis & 2 /* Row */) ? tlp.columns.getTotalSize() : 0, hdrHei = (hdrVis & 1 /* Column */) ? tlp.rows.getTotalSize() : 0, sp = grid.scrollPosition;
                ...
                if (g.isRangeValid(sel) && !e.defaultPrevented) {
                    ...
                    switch (keyCode) {
                        ...
                        case 9 /* Tab */:
                            ...
                            break;
                        case 13 /* Enter */:
                            this._moveSel(1 /* Next */, 0 /* None */, shift);
        ...
        var _MouseHandler = (function () {
            ...
            */
            ...
            _MouseHandler.prototype._mouseSelect = function (e, extend) {
                if (this._htDown && this._htDown.gridPanel && this._g.selectionMode != 0 /* None */) {
